...
<ul>
  <li><a href="https://github.com/WillieLabs/Pentest-Homelab"><b>Home Lab for Penetration Testing</b></a> <i>(Planned)</i><br>
  ...
  <li><a href="https://github.com/Cyb3rWard0g/Incident-Response-Projects-for-Beginners" target="_blank"><b>Incident-Response-Projects-for-Beginners</b></a> <i>(In Progress)</i><br>
    Beginner-friendly incident response labs. Practice simulated phishing, brute-force, malware, and network analysis scenarios. Includes step-by-step instructions, investigation flow, and reporting practice.
  </li>
  <li><a href="https://github.com/TheresAFewConors/Sooty" target="_blank"><b>Sooty</b></a> <i>(In Progress)</i><br>
    Python automation tool for SOC analysts. Quickly perform IOC lookups, URL analysis, DNS queries, and automate repetitive SOC tasks. Great for learning scripting and automation.
  </li>
  <li><a href="https://github.com/PhantomInsights/awesome-soc-analyst" target="_blank"><b>awesome-soc-analyst</b></a> <i>(In Progress)</i><br>
    Curated resource list for SOC analysts. Explore tools, labs, courses, and articles to jumpstart your SOC learning journey.
  </li>
</ul>
